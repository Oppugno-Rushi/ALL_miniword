...
[Your Title]`;
    ...
    getActiveChartControlsRoot() {
        // Predictable version uses sidebar chart controls as the primary source of truth.
        // This avoids conflicts with legacy hidden modal elements that share the same IDs.
    ...
    detectTablesInDocument() {
        // Target the list in the sidebar (Insert Chart sidebar), not the modal's duplicate
        ...
        // Find tables in the main document: #editor (includes .page > .page-content) and .editor-container
