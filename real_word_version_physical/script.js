...
<body>
    ...
    ensureInsertImageMonitorUI() {
        ...
        // Fallback inline styles so the monitor is visible even if stylesheet cache is stale.
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Toolbar icon hover tooltips: show title as custom tooltip, remove native title to avoid double tooltip
    document.querySelectorAll('.toolbar-btn[title]').forEach(function(btn) {
